            ...
            activeDeals.map((deal) => {
               ...
               return (
                <motion.div 
                  ...
                  className={`p-4 rounded-xl border flex justify-between items-center transition-all cursor-pointer group active:scale-[0.98] ${isOverdue ? 'bg-rose-950/10 border-rose-900/30 hover:bg-rose-900/20' : 'bg-slate-900/50 border-slate-800 hover:bg-slate-800'}`}
                  role="button"
                  tabIndex={0}
                >
